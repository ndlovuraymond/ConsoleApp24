       ...
       public static void game()
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    switch (choice)
                    {
                        case "1": if (board[0] == " ") { board[0] = move; game = true; } break;
                        case "2": if (board[1] == " ") { board[1] = move; game = true; } break;
                        case "3": if (board[2] == " ") { board[2] = move; game = true; } break;
                        case "4": if (board[3] == " ") { board[3] = move; game = true; } break;
                        case "5": if (board[4] == " ") { board[4] = move; game = true; } break;
                        case "6": if (board[5] == " ") { board[5] = move; game = true; } break;
                        case "7": if (board[6] == " ") { board[6] = move; game = true; } break;
                        case "8": if (board[7] == " ") { board[7] = move; game = true; } break;
                        case "9": if (board[8] == " ") { board[8] = move; game = true; } break;
                    }
                    if (!game)
                    { Console.WriteLine("Illegal Move!Try Again!"); continue; }
                } while (!game);
